# -*- coding: utf-8 -*-
"""
K-EDGE V9.5.11 TELEGRAM MENU WORKER - POSITIONS + CURRENT EDGE
...
def _ensure_edge_future_exs():
    ...
    try:
        ...
        try:
            core.ENABLE_CALLBACK_POLLER = False
        except Exception:
            pass
...
def current_edge_text(chat_id):
    ...
    valid_sorted = sorted(valid, key=lambda r: r.get("remain", 9999))
...
def poll_loop():
    print("=" * 70)
    print("K-EDGE V9.5.11 TELEGRAM MENU WORKER - POSITIONS + CURRENT EDGE")
